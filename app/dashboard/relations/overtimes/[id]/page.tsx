...
import OvertimePrintBtn from "./printbtn";
import OvertimeRequest from "@/models/overtimes/model";

async function RelationsOvertimeRequestDetail({
  params,
}: {
  params: { id: string };
}) {
  ...
  const data = await OvertimeRequest.findById(id).populate({
    path: "employee",
...
export default RelationsOvertimeRequestDetail;
